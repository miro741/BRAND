...
serpent = dofile("./LIBRE/serpent.lua") 
json = dofile("./LIBRE/JSON.lua") 
JSON  = dofile("./LIBRE/dkjson.lua")
...
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "BR IS NOT FIND IN FILES BOT"
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
exit 1
fi
if [ ! $token ]; then
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BRANDTEAM/Files_BRAND/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,954274863,1033028167}   
...
os.execute('wget https://raw.githubusercontent.com/BRAND45i/BRAND/main/BRAND.lua')
send(msg.chat_id_, msg.id_,'  ✟⇠ تم تحديث السورس \n  ✟⇠ لديك اخر اصدار لسورس برند\n  ✟⇠ الاصدار » { 1.3v}')
dofile('BRAND.lua')  
end
...
⍆══•═══𝘽𝙍══•═══⍅
  ✟⇠ ↬[Information](t.me/@RXTRX)
⍆══•═══𝘽𝙍══•═══⍅
  ✟⇠ ↬[DEVELOPER](t.me/s_x_x_c)
⍆══•═══𝘽𝙍══•═══⍅
  ✟⇠ ↬[The way his inauguration](https://t.me/CXRCX/365)
⍆══•═══𝘽𝙍══•═══⍅
  ✟⇠ ↬[To talk to us](http://t.me/@CXTCXBOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'برند').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'برند')
local BRAND_Msg = {
' وسم شريد 🤨.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'برند').." غادر" or text == 'بوت غادر' then  
...
send(msg.chat_id_, msg.id_, t..'ٴ ✟⇠ٴ⍆══•═══𝘽𝙍══•═══⍅ٴ ✟⇠○ٴ\n ✟⇠ 彡 .[BRᗩ𝗡𝗗 C𝐇𝐀𝐍𝐍𝐄𝑳](t.me/CXRCX)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'برند')
