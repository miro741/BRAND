...
install() {
reset
echo -e "\e[38;5;77m • Welcome to Source devbrand - اهلا بك في سورس براند •\e[0m"
echo -e "\e[38;5;77m      •{ Setting up offices - جاري رفع المكاتب } •\e[0m"
echo -e "\e[38;5;77m • Installing Source devbrand - جاري تحميل سورس براند •\e[0m"
...
echo -e "\e[38;5;77m    |-------------------------------------------|\e[0m"
echo -e "\e[38;5;77m    |This Source Was Developed By (BrAnD) @CXRCX.|\e[0m"
echo -e "\e[38;5;77m    |  This Is The Source Channel @RXTRX .   |\e[0m"
echo -e "\e[38;5;77m    |               - Brand -                 |\e[0m"
echo -e "\e[38;5;77m    ---------------------------------------------\e[0m"
cd ..
rm -rf luarocks*
./tg -s devbrand.lua
